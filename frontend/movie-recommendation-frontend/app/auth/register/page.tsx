            ...
            <div className="relative z-10 w-full max-w-md rounded-[34px] border border-white/10 bg-[#111114]/80 p-8 sm:p-10 shadow-2xl shadow-black/50 backdrop-blur-xl">
                <div className="mb-8 text-center">
                    ...
                    <p className="mt-2 text-sm text-zinc-400">
                        Gia nhập cộng đồng yêu phim ngay hôm nay
                    </p>
                </div>
                ...
                <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="group mt-4 flex w-full items-center justify-center gap-2 rounded-2xl bg-[#c91d1d] px-8 py-4 text-base font-bold text-white shadow-xl shadow-red-950/40 transition hover:bg-[#e02727] disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        {isLoading ? (
                            <>
